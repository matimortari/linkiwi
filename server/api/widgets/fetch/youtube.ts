export default defineEventHandler(async (event) => {
  ...
  const searchRes: any = await $fetch<any>("https://www.googleapis.com/youtube/v3/search", { query: { part: "snippet", channelId, order: "date", type: "video", maxResults: 9, key: apiKey } }).catch(() => null)
